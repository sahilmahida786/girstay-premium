  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Image
              ...
              fill
              priority
              // Responsive object position to keep lion eyes perfectly framed on mobile portrait and desktop landscape
      ...
      {/* ────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────── */}
      <div className="flex-grow flex-shrink-0 min-h-[20vh] lg:min-h-[30vh]" />
      ...
      <motion.div 
        style={{ y: heroY }}
        className="relative z-30 w-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col items-start lg:items-center text-left lg:text-center pb-20 lg:pb-32 flex-shrink-0 pt-20 lg:pt-0"
      >
          ...
          <div className="flex lg:justify-center items-center gap-3 lg:gap-3 w-max lg:w-auto pr-8 lg:pr-0">
            {trustPills.map((pill, i) => (
              ...
              >
                ...
                <div className="w-10 h-10 lg:w-auto lg:h-auto rounded-full bg-[#D4AF37]/10 lg:bg-transparent flex items-center justify-center flex-shrink-0 border border-[#D4AF37]/20 lg:border-none">
        ...
        <motion.h1 
          ...
          className="order-1 lg:order-2 font-serif text-[clamp(2.75rem,11vw,4.5rem)] leading-[1.05] sm:text-5xl lg:text-7xl font-medium text-white mb-5 lg:mb-8 tracking-tight max-w-[900px] text-balance drop-shadow-2xl"
        >
        ...
        <motion.p 
          ...
          className="order-2 lg:order-3 text-white/85 text-[16px] leading-[24px] sm:text-lg lg:text-[19px] lg:leading-[1.9] font-light max-w-[320px] sm:max-w-[420px] lg:max-w-[680px] mb-8 lg:mb-12 text-balance drop-shadow-md"
        >
        ...
        >
          ...
          <button className="relative h-[56px] px-8 rounded-full bg-white/5 backdrop-blur-xl border border-white/20 text-white font-medium uppercase tracking-[0.15em] text-[12px] transition-all duration-300 hover:bg-white/10 hover:border-[#D4AF37]/50 active:scale-[0.98] flex items-center justify-center gap-3 group overflow-hidden">
        ...
        <motion.div
          ...
          className="lg:hidden order-5 w-full mt-4"
        >
          <button className="relative w-full h-[56px] rounded-2xl bg-white/5 backdrop-blur-xl border border-white/20 text-white font-medium uppercase tracking-[0.15em] text-[13px] transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-3 overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none z-30"
      >
