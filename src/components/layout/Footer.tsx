  ...
  return (
    <footer className="relative bg-card border-t border-border/50">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-[104px] lg:bottom-6 right-3 sm:right-6 z-40 w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-green-500 flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-300"
